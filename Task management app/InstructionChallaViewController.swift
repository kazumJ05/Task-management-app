//
//  InstructionChallaViewController.swift
//  Task management app
//
//  Created by 大原一倫 on 2019/07/19.
//  Copyright © 2019 oharakazumasa. All rights reserved.
//

import UIKit

class InstructionChallaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        image12.image = UIImage(named: "kingpengwinDark.png")
